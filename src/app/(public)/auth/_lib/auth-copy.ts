export const AUTH_COPY = {
  ...
  settingsEyebrow: "Hesap bilgileri",
  settingsTitle: "Hesabında kayıtlı bilgiler",
  settingsDescription: "Bu yüzey şu anda yalnız görüntüleme amaçlıdır.",
  settingsReadonlyBody:
    "Bu seam yalnız kayıtlı bilgileri gösterir. Bu turda hesap bilgileri değiştirilemez.",
  settingsUsernameLabel: "Kullanıcı adı",
