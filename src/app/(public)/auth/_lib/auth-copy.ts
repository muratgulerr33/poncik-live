export const AUTH_COPY = {
  ...
  settingsPasswordCurrentInputLabel: "Eski şifre",
  settingsPasswordNewInputLabel: "Yeni şifre",
  settingsPasswordConfirmInputLabel: "Yeni şifre",
  settingsPasswordSubmitLabel: "Güncelle",
  settingsPasswordSuccessInlineLabel: "Şifre güncellendi",
  settingsPasswordMismatchBody: "Yeni şifreler eşleşmiyor.",
  settingsPasswordPolicyBody: "Şifre 8 ile 72 karakter arasında olmalı.",
  settingsPasswordSameAsOldBody: "Yeni şifre eski şifreyle aynı olamaz.",
  settingsPasswordWrongCurrentBody: "Eski şifre doğru değil.",
  settingsPasswordUnavailableBody:
